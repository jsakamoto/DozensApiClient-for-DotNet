...
namespace DozensAPI
{
    public class DozensExceptionDetail
    {
    ...
    public class DozensException : Exception
    {
        ...
        public DozensExceptionDetail Detail { get; protected set; }
        ...
        public DozensException(int code, string message, DozensExceptionDetail detail, Exception innerException)
